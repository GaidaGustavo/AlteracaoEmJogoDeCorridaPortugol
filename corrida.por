...
programa
{
	...
	const real ATRITO = 3.035, ACELERACAO = 6.085, FREIO = 0.135

	/* Constantes que determinam a velocidade dos veículos no jogo */
	const real VELOCIDADE_MAXIMA_JOGADOR = 1200.0, VELOCIDADE_MAXIMA_VEICULOS = 110.0, VELOCIDADE_MINIMA_VEICULOS = 5.0

	/* Constantes que determinam as propriedades dos galões de combustível espalhados na estrada  */
	const real MAXIMO_COMBUSTIVEL = 200000000000.0, COMBUSTIVEL_GALAO = 50000000000.0

	/* Constantes que controlam a quantidade de dano causado pelas batidas */
	const real MAXIMO_DANOS = 1000.0, TAXA_DANOS = 00.0
	...
	const inteiro MAIOR_DISTANCIA_REPAROS = 1200000000, MENOR_DISTANCIA_REPAROS = 9000000

	/* Constantes que ajudam a determinar a frequência com que os galões de combustível aparecem na tela */
	const inteiro MAIOR_DISTANCIA_GALOES = 50, MENOR_DISTANCIA_GALOES = 10
	
	/* Constantes que ajudam a determinar a frequência com que os veículos aparecem na tela */
	const inteiro MAIOR_DISTANCIA_VEICULOS = 50000, MENOR_DISTANCIA_VEICULOS = 49999
	...
	{
		cadeia convertido = tp.inteiro_para_cadeia(pontuacao, 2)
		...
		g.definir_cor(0xFFFFFF)
		g.definir_estilo_texto(falso, verdadeiro, falso)
		g.desenhar_texto(x, y, convertido)
	}
	...
	funcao carregar_imagens()
	{
		...
		imagem_estrada = g.carregar_imagem(diretorio_imagens + "mato.png")
		imagem_veiculos = g.carregar_imagem(diretorio_imagens + "veiculosalternativos.png")
 ...
 * 
 * @POSICAO-CURSOR = 28187; 
 * @DOBRAMENTO-CODIGO = [1, 177, 192, 205, 220, 228, 235, 248, 276, 292, 321, 334, 344, 356, 371, 380, 390, 394, 400, 405, 409, 414, 419, 423, 428, 369, 361, 437, 442, 447, 452, 460, 465, 476, 487, 498, 504, 496, 513, 567, 558, 547, 545, 622, 609, 650, 637, 665, 685, 692, 699, 706, 717, 721, 725, 731, 740, 748, 755, 760, 788, 814, 836, 862, 884, 889, 904, 934, 944, 949, 997, 1040, 1048, 1069, 1090, 1120, 1134, 1145, 1203, 1209, 1236, 1260, 1278, 1286, 1298, 1317, 1329, 1315, 1337, 1343, 1335, 1351, 1357, 1349, 1372, 1378];
 * @PONTOS-DE-PARADA = ;
